...
//        }, t -> builderCtx.getLogger().error(t));
    ...
    private void scanImplementation(
            ...
            final ServiceMeta svcMethodMeta,
    ...
    private void implementIRestfulService(
        ...
        Observable.from(builderCtx.getBuilders())
                ...
                .subscribe(clsBuilder -> {
                    Map<String, ServiceMeta> httpMethodMappings = clsBuilder.getTransience(HTTP_TO_METHOD_ARGS_MAPPING);
    ...
    private List<String> getHttpMethods(
            uapi.service.MethodMeta methodMeta, Map<String, ServiceMeta> httpMethodMapping) {
